...
#
# Note how $p$ has mode at $x = \frac12$ in the center of the domain, whereas $q$ has mode at $y = 0$ on the end.  How can these behaviors be so different while representing the same situation?  When speaking of likely values of $r$, should we take $r(x^2)$ with $x$ near $\frac12$, or should we take $r(y)$ with $y$ near $0$, or should we do something else?
